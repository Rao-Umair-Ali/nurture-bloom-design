...
const contactInfo = [
  ...
  { icon: Mail, label: "Email", value: "hello@drsofiasdaycare.com", href: "mailto:hello@drsofiasdaycare.com" },
  { icon: MapPin, label: "Address", value: "123 Sunshine Street, Happy Valley, ST 12345", href: "#" },
  { icon: Clock, label: "Hours", value: "Mon-Fri: 7AM-6PM, Sat: 8AM-1PM", href: "#" },
];
      ...
      <section className="pt-32 pb-16 gradient-bg">
        <div className="container-custom">
          <SectionHeading
            ...
            description="Have questions or ready to schedule a tour? Get in touch with us today!"
          />
        </div>
      </section>
        ...
        <div className="container-custom">
          <div ref={ref} className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="bg-card rounded-3xl p-8 shadow-card">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <Input placeholder="e.g., 2 years old" className="rounded-xl" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">Message</label>
                    <Textarea placeholder="Tell us about your childcare needs..." rows={4} className="rounded-xl" />
                  </div>
            ...
            <div className={cn("opacity-0", isInView && "animate-slide-in-right")}>
              ...
              <p className="text-muted-foreground mb-8">We're here to answer any questions you have. Reach out and we'll respond within 24 hours.</p>
